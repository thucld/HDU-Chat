...
public class ContactListAdapter extends RecyclerView.Adapter<ContactListAdapter.ViewHolder> implements View.OnClickListener {
    ...
    private String mInsRecordId;
    private List<User> mDataSet;
    private PostItemListener mItemListener;
    private static int mSelectedItem = -1;

    public ContactListAdapter(Context context, List<User> dataSet, String insRecordId, PostItemListener itemListener) {
        this.mContext = context;
        this.mInsRecordId = insRecordId;
